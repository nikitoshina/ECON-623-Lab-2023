...
![src: http://inkfumes.blogspot.com/2011/10/poster-designs-color-design-typography.html](images/COLORTHEORY_A.jpeg)
## Categorical Data
...
To see how these spaces look, check out [this amazing video](https://www.youtube.com/watch?v=HlDySNpGbyc)!
...
![uniform_perception](images/uniform_perception.jpg)
...
!["Color Blind Rainbow Flower"](images/Color_Blindness.jpg)
...
If you want to pick colors yourself use HSL, because it is the most intuitive one and the easiest to make color palettes in. I would also recommend tinkering with OKHSL, which is a child of OKLAB and HSL producing a perceptually uniform HSL space. Try out both of them and see the difference [here](https://bottosson.github.io/misc/colorpicker/). 
